...
- **Window Size Refactoring**: Move window size logic out of `helpers.py` into the JSON definitions (Completed; updated window overrides to treat the last numeric threshold as equal-or-greater-than and added automatic window capacity safety guard).
