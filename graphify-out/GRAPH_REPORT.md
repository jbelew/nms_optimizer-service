# Graph Report - nms_optimizer-service  (2026-09-14)

## Corpus Check
- 139 files · ~118,589 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2258 nodes · 4096 edges · 428 communities (107 shown, 321 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 77 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5250fc61`
...
- TestCountEmptyInLocalized
- TestConvertMapKeysToTuple
...
- .test_old_logic_case_166_solar_cargo_scanner_count_1
...
- .test_old_logic_case_180_pilgrim_radiation_count_1
- .test_old_logic_case_181_pilgrim_toxic_count_1
...
- .test_old_logic_case_082_sentinel_hyper_count_9
...
- .test_bolt_caster_any_count
- .test_optimize_solve_map_no_pattern_fits_falls_back_to_sa_when_forced
- .test_old_logic_case_146_colossus_radar_count_1
- .test_old_logic_case_012_standard_conflict_scanner_count_1
- .test_refinement_does_not_improve_score
...
- `generate_solve_map()` --calls--> `simulated_annealing()`  [EXTRACTED]
  scripts/debugging_utils/generate_solves.py → src/optimization/refinement.py
...
- `generate_solve_map()` --calls--> `print_grid()`  [EXTRACTED]
  scripts/debugging_utils/solve_map_generator.py → src/grid_display.py
- `generate_solve_map()` --calls--> `Grid`  [EXTRACTED]
...
## Communities (428 total, 321 thin omitted)

### Community 0 - "grid_utils.py"
Cohesion: 0.07
Nodes (42): generate_solve_map(), generate_solve_map_template(), Generates a solve map template from a Grid object., Generates a single solve map for a given technology and ship type. Args:…, get_tech_modules(), get_tech_modules_for_training(), get_tech_tree(), get_tech_tree_json() (+34 more)

### Community 1 - "Grid"
Cohesion: 0.03
Nodes (44): Grid, Sets the label for a module in a specific cell. Args: x (int): The x-coordinate…, Sets the supercharged status of a specific cell. Args: x (int): The…, Sets the active status of a specific cell. Args: x (int): The x-coordinate of…, Checks if a specific cell is supercharged. Args: x (int): The x-coordinate of…, Sets the adjacency bonus for a module in a specific cell. Args: x (int): The…, Sets the base bonus for a module in a specific cell. Args: x (int): The…, Sets the type for a module in a specific cell. Args: x (int): The x-coordinate… (+36 more)

### Community 2 - "TestOptimizationPipeline"
Cohesion: 0.18
Nodes (9): get_tech_modules_from_ship_data(), Test that optimization considers supercharged slots. This test verifies: 1.…, Test optimization on grid with some inactive cells. This test verifies: 1.…, Extract modules for a specific tech from ship data structure. Ship data…, Test full optimization workflow end-to-end., Set up common test resources., Test pipeline from pattern matching to refinement. This test verifies: 1.…, Test that optimization falls back to simulated annealing when needed. This test… (+1 more)

### Community 3 - "optimize_placement"
Cohesion: 0.09
Nodes (33): calculate_grid_score(), Calculates the total grid score for a given technology using the Rust…, get_model_keys(), Determines keys for model filename and module definitions. 1. Establishes…, apply_localized_grid_changes(), Restores the original state of cells in the main grid that were temporarily…, Applies changes from a localized grid back to the main grid. Only modules of…, restore_original_state() (+25 more)
...
Cohesion: 0.08
Nodes (32): Runs a benchmark on the simulated annealing algorithm., run_benchmark(), generate_all_input_grids(), _generate_random_input_grid(), get_module_id_mapping(), Creates a mapping from module ID to its class index (1-based)., Generates all possible grid layouts with supercharged and inactive cells.…, Generates a random grid layout with supercharged and inactive cells. Returns a… (+24 more)

### Community 8 - "patch"
Cohesion: 0.12
Nodes (8): patch, Test behavior when no solve map is found for the ship (uses adjacency scoring)., Test returns 'Pattern No Fit' when solve map exists, no pattern fits, and not…, Test returns 'Pattern No Fit' when a partial set has no window and is not…, Test fallback to full SA for a partial set with no window when forced=True., Test that refinement improves the score., Test that final fallback SA improves the score., Test that optimize_placement returns an error if no modules are found for the…
...
### Community 11 - "TestCountEmptyInLocalized"
Cohesion: 0.12
Nodes (9): Adversarial tests for count_empty_in_localized, Completely empty grid should return full count, Completely full grid should return 0, Partially filled grid should return correct count, Single cell empty grid should return 1, Single cell full grid should return 0, Should count all cells including inactive ones, Large grid should count correctly (+1 more)

### Community 12 - "TestConvertMapKeysToTuple"
Cohesion: 0.08
Nodes (13): Test the tuple key conversion utility., Convert simple '0,0' string to (0,0) tuple., Convert multiple tuple string keys., Non-tuple-like string keys should be preserved., Convert tuple keys in nested dictionaries., Convert tuple keys in dictionaries within lists., Invalid tuple strings should remain unchanged., Handle negative coordinate values. (+5 more)

### Community 13 - "clear_all_modules_of_tech"
Cohesion: 0.09
Nodes (26): clear_all_modules_of_tech(), Removes all modules of a specific technology from the grid. This function…, Core optimization module for NMS grid module placement. This module…, apply_pattern_to_grid(), _extract_pattern_from_grid(), get_all_unique_pattern_variations(), mirror_pattern_horizontally(), mirror_pattern_vertically() (+18 more)
...
### Community 15 - "bonus_calculations.py"
Cohesion: 0.07
Nodes (26): Enum, RustGrid, AdjacencyType, calculate_score_delta(), clear_scores(), _get_orthogonal_neighbors(), ModuleType, Grid (+18 more)
...
### Community 21 - "place_module"
Cohesion: 0.06
Nodes (26): place_module(), Populates a grid cell with the data for a specific module. This function sets…, Comprehensive test suite for module_placement.py This test suite focuses on…, Should handle various bonus values correctly., Should handle None image gracefully., Should handle string image paths., Test module placement on grid cells., Set up a clean grid for each test. (+18 more)

### Community 22 - "TestOptimization"
Cohesion: 0.13
Nodes (3): Set up common test resources., Test a successful pattern match with no refinement opportunity., TestOptimization
...
Cohesion: 0.09
Nodes (12): Test applying patterns to grids with various edge cases., Set up common test fixtures., Apply a simple pattern to an empty grid., Pattern that goes off-grid should return None., Pattern with negative offset should fail gracefully., Pattern with modules player doesn't own should return None., Applying a pattern shouldn't remove other tech modules., Pattern placement on inactive cells should fail. (+4 more)
...
### Community 32 - "TestMultipleTechOptimization"
Cohesion: 0.21
...
### Community 33 - "app.py"
Cohesion: 0.06
Nodes (32): after_request, date, on, initialize_clients(), Initializes the Google Analytics and BigQuery clients. It attempts to load…, add_cache_headers(), get_ship_types(), get_technology_tree() (+24 more)
...
Cohesion: 0.06
Nodes (24): calculate_pattern_adjacency_score(), Calculates a heuristic adjacency score for a placed pattern. This score is not…, Test that lesser_2 module score scales correctly with number of matching…, Test that different rule values in the same family (e.g. greater_3 and…, Tests for adjacency-based module placement logic, Test that calculate_grid_score rounds the score to 4 decimal places to prevent…, Grid with no modules of tech should score 0, Modules of different tech should be ignored in scoring (+16 more)
...
Cohesion: 0.18
Nodes (6): Tests for the logic of the placement algorithm itself, Simulating the placement algorithm to verify best position selection, Multi-module placement should consider already-placed modules, Clearing modules of a tech should reset scoring, Algorithm should skip inactive cells, TestPlacementAlgorithmLogic
...
### Community 53 - "TestPatternExtraction"
Cohesion: 0.18
...
Cohesion: 0.20
Nodes (6): Old Logic: corvette launch (6 modules), Old Logic: sentinel infra (5 modules), Old Logic: nomad radiation (1 modules), This class captures the behavior of `determine_window_dimensions` as it was at…, Old Logic: minotaur liquidator-right (4 modules), TestOldDetermineWindowDimensionsBehavior
...
Cohesion: 0.25
Nodes (5): Pulse-spitter/jetpack <7 modules should use generic logic (fallback to 3x3 for…, Adversarial tests for determine_window_dimensions, Zero modules returns 1x1 default fallback logic, Corvette with 7 modules (non-pulse) should return exact 7 fallback 3x3, TestDetermineWindowDimensions
...
Cohesion: 0.20
Nodes (7): patch, Test analytics/popular data endpoint., Analytics endpoint should exist., Test popular analytics data retrieved from BigQuery., Test fallback to GA4 when BigQuery query fails., Test popular analytics responses are cached., TestAnalyticsEndpoint
...
Cohesion: 0.40
Nodes (3): Test performance analytics data endpoint., Test performance analytics response includes p50, p75, and p90., TestPerformanceAnalyticsEndpoint
...
### Community 91 - "_prepare_optimization_run"
Cohesion: 0.14
Nodes (12): _prepare_optimization_run(), Grid, Prepares the optimization run by validating the grid and retrieving available…, Adversarial tests for optimization/core.py Focus on orchestration logic, edge…, Returned grid should be new instance, not original, Tests for _prepare_optimization_run function, When no modules found, should return (cleared_grid, 0.0, 0.0, error_msg), When no empty active slots, should raise ValueError (+4 more)
...
### Community 93 - "TestOptimizationErrorHandling"
Cohesion: 0.17
Nodes (7): Test error handling in optimization pipeline., Set up common test resources., Test optimization handles empty module list gracefully., Test optimization with invalid ship gracefully fails., Test that optimization doesn't change grid dimensions., Test optimization works with various grid sizes., TestOptimizationErrorHandling
...
### Community 116 - "determine_window_dimensions"
Cohesion: 0.22
Nodes (5): determine_window_dimensions(), Old Logic: solar trails (12 modules), Old Logic: exosuit core_health (3 modules), Old Logic: roamer flamethrower (1 modules), Old Logic: standard infra (5 modules)

### Community 139 - "get_module_data"
Cohesion: 0.22
Nodes (5): get_module_data(), Loads the module data for a specific ship type from its JSON file. Results are…, Old Logic: roamer cold (1 modules), Old Logic: standard-mt voltaic-amplifier (1 modules), Old Logic: standard rocket (2 modules)
...
- **Why does `Grid` connect `Grid` to `grid_utils.py`, `TestOptimizationPipeline`, `optimize_placement`, `TestScEligibleAdversarial`, `data_loader.py`, `TestScEligibleEdgeCases`, `TestOptimizeOptimizationFlow`, `TestCountEmptyInLocalized`, `clear_all_modules_of_tech`, `TestScanGridWithWindow`, `bonus_calculations.py`, `TestRefinePlacement`, `calculate_window_score`, `TestClearAllModulesOfTech`, `._create_grid`, `place_module`, `TestOptimization`, `TestCreateLocalizedGrid`, `TestCreateLocalizedGridML`, `TestPatternApplicationToGrid`, `TestAvailableModulesPatternMatching`, `TestPlaceAllModulesInEmptySlots`, `rotate_pattern`, `TestMultipleTechOptimization`, `app.py`, `calculate_pattern_adjacency_score`, `TestPlacementAlgorithmLogic`, `TestPartialModuleSetEdgeCases`, `TestPatternVariationGeneration`, `TestWindowSizeValidation`, `TestMLPlacementOutputValidation`, `TestWindowScoringAndSelection`, `TestRefinementStageEdgeCases`, `TestMLPlacementModelLoading`, `TestPatternExtraction`, `TestGridUtils`, `TestMLPlacementModuleAssignment`, `TestMLPlacementPolishing`, `TestMLPlacementGridHandling`, `TestMLPlacementErrorHandling`, `TestSuperchargedWindowDetection`, `TestScEligibleWindowSizeWithConstraint`, `TestMLPlacementTensorPreparation`, `TestMLPlacementProgressCallback`, `TestMLPlacementIntegration`, `TestInitialPlacementFallback`, `TestDetermineWindowDimensions`, `_prepare_optimization_run`, `TestOptimizationErrorHandling`, `generate_solves.py`, `TestPatternEdgeCases`?**
  _High betweenness centrality (0.374) - this node is a cross-community bridge._
- **Why does `determine_window_dimensions()` connect `determine_window_dimensions` to `grid_utils.py`, `optimize_placement`, `data_loader.py`, `clear_all_modules_of_tech`, `train_model.py`, `TestWindowSizeValidation`, `TestOldDetermineWindowDimensionsBehavior`, `.test_old_logic_case_166_solar_cargo_scanner_count_1`, `.test_old_logic_case_238_staves_cloaking_count_1`, `TestDetermineWindowDimensions`, `.test_old_logic_case_176_pilgrim_mounted_count_4`, `.test_old_logic_case_226_staves_analysis_count_1`, `.test_old_logic_case_094_nomad_boost_count_4`, `.test_old_logic_case_095_nomad_slide_count_1`, `.test_old_logic_case_164_solar_conflict_scanner_count_1`, `.test_old_logic_case_165_solar_economy_scanner_count_1`, `.test_old_logic_case_105_nomad_cyclops_count_1`, `.test_old_logic_case_168_solar_teleporter_count_1`, `.test_old_logic_case_014_standard_cargo_scanner_count_1`, `.test_old_logic_case_170_pilgrim_icarus_count_1`, `.test_old_logic_case_172_pilgrim_slide_count_1`, `.test_old_logic_case_173_pilgrim_grip_count_1`, `.test_old_logic_case_174_pilgrim_drift_count_1`, `.test_old_logic_case_175_pilgrim_mining_count_5`, `.test_old_logic_case_169_pilgrim_fusion_count_4`, `.test_old_logic_case_015_standard_trails_count_12`, `.test_old_logic_case_177_pilgrim_flamethrower_count_1`, `.test_old_logic_case_178_pilgrim_thermal_count_1`, `.test_old_logic_case_179_pilgrim_cold_count_1`, `.test_old_logic_case_180_pilgrim_radiation_count_1`, `.test_old_logic_case_181_pilgrim_toxic_count_1`, `.test_old_logic_case_182_pilgrim_cyclops_count_1`, `.test_old_logic_case_183_pilgrim_radar_count_1`, `.test_old_logic_case_184_pilgrim_amplifier_count_1`, `.test_old_logic_case_185_pilgrim_power_count_1`, `.test_old_logic_case_186_nautilon_humboldt_count_5`, `.test_old_logic_case_016_standard_teleporter_count_1`, `.test_old_logic_case_187_nautilon_icarus_count_1`, `.test_old_logic_case_188_nautilon_dredging_count_1`, `get_module_data`, `.test_old_logic_case_189_nautilon_tethys_count_1`, `.test_old_logic_case_190_nautilon_nautilon_count_4`, `.test_old_logic_case_192_nautilon_sonar_count_1`, `.test_old_logic_case_193_living_grafted_count_4`, `.test_old_logic_case_194_living_spewing_count_4`, `.test_old_logic_case_195_living_scream_count_4`, `.test_old_logic_case_196_living_assembly_count_5`, `.test_old_logic_case_191_nautilon_cyclops_count_1`, `.test_old_logic_case_017_atlantid_mining_count_7`, `.test_old_logic_case_198_living_pulsing_count_4`, `.test_old_logic_case_197_living_singularity_count_5`, `.test_old_logic_case_200_living_bobble_count_4`, `.test_old_logic_case_201_living_scanners_count_2`, `.test_old_logic_case_199_living_saline_count_1`, `.test_old_logic_case_202_living_trails_count_12`, `.test_old_logic_case_204_exosuit_refiner_count_1`, `.test_old_logic_case_205_exosuit_life_count_6`, `.test_old_logic_case_203_exosuit_jetpack_count_8`, `.test_old_logic_case_018_atlantid_analysis_count_1`, `.test_old_logic_case_207_exosuit_anomaly_count_1`, `.test_old_logic_case_208_exosuit_hazard_count_1`, `.test_old_logic_case_209_exosuit_pressure_count_1`, `.test_old_logic_case_038_corvette_phase_count_5`, `.test_old_logic_case_211_exosuit_radiation_count_4`, `.test_old_logic_case_210_exosuit_coolant_count_4`, `.test_old_logic_case_213_exosuit_thermic_count_4`, `.test_old_logic_case_214_exosuit_toxin_count_4`, `.test_old_logic_case_212_exosuit_aeration_count_4`, `.test_old_logic_case_216_exosuit_defense_count_3`, `.test_old_logic_case_215_exosuit_protection_count_4`, `.test_old_logic_case_217_exosuit_rebuilt_count_3`, `.test_old_logic_case_218_exosuit_forbidden_count_3`, `.test_old_logic_case_019_atlantid_fishing_count_1`, `.test_old_logic_case_220_exosuit_hazmat_count_1`, `.test_old_logic_case_221_exosuit_nutrient_count_1`, `.test_old_logic_case_222_exosuit_skiff_count_1`, `.test_old_logic_case_223_exosuit_trade_count_1`, `.test_old_logic_case_224_exosuit_exocraft_count_1`, `.test_old_logic_case_225_staves_mining_count_6`, `.test_old_logic_case_219_exosuit_translators_count_4`, `.test_old_logic_case_020_atlantid_gravatino_count_1`, `.test_old_logic_case_227_staves_fishing_count_1`, `.test_old_logic_case_228_staves_gravatino_count_1`, `.test_old_logic_case_229_staves_scanner_count_7`, `.test_old_logic_case_230_staves_survey_count_1`, `.test_old_logic_case_231_staves_blaze_javelin_count_6`, `.test_old_logic_case_232_staves_bolt_caster_count_9`, `.test_old_logic_case_233_staves_geology_count_4`, `.test_old_logic_case_234_staves_neutron_count_5`, `.test_old_logic_case_235_staves_plasma_launcher_count_4`, `.test_old_logic_case_236_staves_pulse_spitter_count_7`, `.test_old_logic_case_021_atlantid_scanner_count_7`, `.test_old_logic_case_237_staves_scatter_count_5`, `.test_old_logic_case_171_pilgrim_boost_count_4`, `.test_old_logic_case_239_staves_combat_count_1`, `.test_old_logic_case_240_staves_voltaic_amplifier_count_1`, `.test_old_logic_case_241_staves_paralysis_count_1`, `.test_old_logic_case_242_staves_personal_count_1`, `.test_old_logic_case_243_staves_terrian_count_1`, `.test_old_logic_case_244_sentinel_mt_mining_count_7`, `.test_old_logic_case_245_sentinel_mt_analysis_count_1`, `.test_old_logic_case_246_sentinel_mt_fishing_count_1`, `.test_old_logic_case_022_atlantid_survey_count_1`, `.test_old_logic_case_247_sentinel_mt_gravatino_count_1`, `.test_old_logic_case_248_sentinel_mt_scanner_count_7`, `.test_old_logic_case_249_sentinel_mt_survey_count_1`, `.test_old_logic_case_250_sentinel_mt_blaze_javelin_count_6`, `.test_old_logic_case_252_sentinel_mt_geology_count_4`, `.test_old_logic_case_253_sentinel_mt_neutron_count_5`, `.test_old_logic_case_254_sentinel_mt_plasma_launcher_count_4`, `.test_old_logic_case_255_sentinel_mt_pulse_spitter_count_7`, `.test_old_logic_case_023_atlantid_blaze_javelin_count_6`, `.test_old_logic_case_256_sentinel_mt_scatter_count_5`, `.test_old_logic_case_258_sentinel_mt_combat_count_1`, `.test_old_logic_case_259_sentinel_mt_voltaic_amplifier_count_1`, `.test_old_logic_case_260_sentinel_mt_paralysis_count_1`, `.test_old_logic_case_257_sentinel_mt_cloaking_count_1`, `.test_old_logic_case_262_sentinel_mt_terrian_count_1`, `.test_old_logic_case_261_sentinel_mt_personal_count_1`, `.test_old_logic_case_263_roamer_fusion_count_4`, `.test_old_logic_case_265_roamer_boost_count_4`, `.test_old_logic_case_266_roamer_slide_count_1`, `.test_old_logic_case_024_atlantid_bolt_caster_count_9`, `.test_old_logic_case_264_roamer_icarus_count_1`, `.test_old_logic_case_268_roamer_drift_count_1`, `.test_old_logic_case_267_roamer_grip_count_1`, `.test_old_logic_case_270_roamer_mounted_count_4`, `.test_old_logic_case_059_standard_mt_scanner_count_7`, `.test_old_logic_case_269_roamer_mining_count_5`, `.test_old_logic_case_272_roamer_thermal_count_1`, `.test_old_logic_case_072_standard_mt_personal_count_1`, `.test_old_logic_case_275_roamer_toxic_count_1`, `.test_old_logic_case_276_roamer_cyclops_count_1`, `.test_old_logic_case_025_atlantid_geology_count_4`, `.test_old_logic_case_274_roamer_radiation_count_1`, `.test_old_logic_case_277_roamer_radar_count_1`, `.test_old_logic_case_278_roamer_amplifier_count_1`, `.test_old_logic_case_279_roamer_power_count_1`, `.test_old_logic_case_000_standard_cyclotron_count_5`, `.test_old_logic_case_027_atlantid_plasma_launcher_count_4`, `.test_old_logic_case_028_atlantid_pulse_spitter_count_7`, `.test_old_logic_case_251_sentinel_mt_bolt_caster_count_9`, `.test_old_logic_case_030_atlantid_cloaking_count_1`, `.test_old_logic_case_026_atlantid_neutron_count_5`, `.test_old_logic_case_029_atlantid_scatter_count_5`, `.test_old_logic_case_031_atlantid_combat_count_1`, `.test_old_logic_case_034_atlantid_personal_count_1`, `.test_old_logic_case_035_atlantid_terrian_count_1`, `.test_old_logic_case_036_corvette_cyclotron_count_5`, `.test_old_logic_case_074_sentinel_cyclotron_count_5`, `.test_old_logic_case_032_atlantid_voltaic_amplifier_count_1`, `.test_old_logic_case_033_atlantid_paralysis_count_1`, `.test_old_logic_case_039_corvette_photon_count_5`, `.test_old_logic_case_037_corvette_infra_count_5`, `.test_old_logic_case_041_corvette_rocket_count_2`, `.test_old_logic_case_043_corvette_hyper_count_9`, `.test_old_logic_case_042_corvette_shield_count_5`, `.test_old_logic_case_084_sentinel_aqua_count_1`, `.test_old_logic_case_046_corvette_pulse_count_8`, `.test_old_logic_case_002_standard_phase_count_5`, `.test_old_logic_case_047_corvette_habitation_count_3`, `.test_old_logic_case_044_corvette_cockpit_count_1`, `.test_old_logic_case_049_corvette_bobble_count_4`, `.test_old_logic_case_050_corvette_conflict_scanner_count_1`, `.test_old_logic_case_048_corvette_aqua_count_1`, `.test_old_logic_case_052_corvette_cargo_scanner_count_1`, `.test_old_logic_case_051_corvette_economy_scanner_count_1`, `.test_old_logic_case_053_corvette_trails_count_12`, `.test_old_logic_case_055_standard_mt_mining_count_6`, `.test_old_logic_case_056_standard_mt_analysis_count_1`, `.test_old_logic_case_003_standard_photon_count_5`, `.test_old_logic_case_057_standard_mt_fishing_count_1`, `.test_old_logic_case_054_corvette_teleporter_count_1`, `.test_old_logic_case_058_standard_mt_gravatino_count_1`, `.test_old_logic_case_060_standard_mt_survey_count_1`, `.test_old_logic_case_061_standard_mt_blaze_javelin_count_6`, `.test_old_logic_case_062_standard_mt_bolt_caster_count_9`, `.test_old_logic_case_064_standard_mt_neutron_count_5`, `.test_old_logic_case_065_standard_mt_plasma_launcher_count_4`, `.test_old_logic_case_066_standard_mt_pulse_spitter_count_7`, `.test_old_logic_case_004_standard_positron_count_5`, `.test_old_logic_case_063_standard_mt_geology_count_4`, `.test_old_logic_case_067_standard_mt_scatter_count_5`, `.test_old_logic_case_068_standard_mt_cloaking_count_1`, `.test_old_logic_case_069_standard_mt_combat_count_1`, `.test_old_logic_case_071_standard_mt_paralysis_count_1`, `.test_old_logic_case_040_corvette_positron_count_5`, `.test_old_logic_case_089_sentinel_cargo_scanner_count_1`, `.test_old_logic_case_073_standard_mt_terrian_count_1`, `.test_old_logic_case_096_nomad_grip_count_1`, `.test_old_logic_case_076_sentinel_phase_count_5`, `.test_old_logic_case_111_minotaur_icarus_count_1`, `.test_old_logic_case_077_sentinel_positron_count_5`, `.test_old_logic_case_079_sentinel_photon_count_5`, `.test_old_logic_case_080_sentinel_shield_count_5`, `.test_old_logic_case_081_sentinel_launch_count_6`, `.test_old_logic_case_078_sentinel_rocket_count_2`, `.test_old_logic_case_083_sentinel_pulse_count_8`, `.test_old_logic_case_082_sentinel_hyper_count_9`, `.test_old_logic_case_086_sentinel_pilot_count_1`, `.test_old_logic_case_006_standard_shield_count_5`, `.test_old_logic_case_087_sentinel_conflict_scanner_count_1`, `.test_old_logic_case_088_sentinel_economy_scanner_count_1`, `.test_old_logic_case_091_sentinel_teleporter_count_1`, `.test_old_logic_case_090_sentinel_trails_count_12`, `.test_old_logic_case_093_nomad_icarus_count_1`, `.test_old_logic_case_092_nomad_fusion_count_4`, `.test_old_logic_case_007_standard_hyper_count_9`, `.test_old_logic_case_097_nomad_drift_count_1`, `.test_old_logic_case_099_nomad_mounted_count_4`, `.test_old_logic_case_104_nomad_toxic_count_1`, `.test_old_logic_case_008_standard_launch_count_6`, `.test_old_logic_case_098_nomad_mining_count_5`, `.test_old_logic_case_109_minotaur_daedalus_count_7`, `.test_old_logic_case_100_nomad_flamethrower_count_1`, `.test_old_logic_case_101_nomad_thermal_count_1`, `.test_old_logic_case_102_nomad_cold_count_1`, `.test_old_logic_case_124_freighter_hyper_count_11`, `.test_old_logic_case_110_minotaur_ariadnes_count_1`, `.test_old_logic_case_116_minotaur_liquidator_left_count_1`, `.test_old_logic_case_106_nomad_radar_count_1`, `.test_old_logic_case_009_standard_pulse_count_8`, `.test_old_logic_case_107_nomad_amplifier_count_1`, `.test_old_logic_case_108_nomad_power_count_1`, `.test_old_logic_case_122_minotaur_hardframe_body_count_1`, `.test_old_logic_case_132_freighter_fleet_trade_count_3`, `.test_old_logic_case_133_colossus_fusion_count_4`, `.test_old_logic_case_112_minotaur_minotaur_laser_count_6`, `.test_old_logic_case_113_minotaur_minotaur_count_4`, `.test_old_logic_case_114_minotaur_hardframe_right_count_1`, `.test_old_logic_case_126_freighter_matterbeam_count_1`, `.test_old_logic_case_135_colossus_boost_count_4`, `.test_old_logic_case_136_colossus_slide_count_1`, `.test_old_logic_case_117_minotaur_environment_count_1`, `.test_old_logic_case_118_minotaur_cyclops_count_1`, `.test_old_logic_case_119_minotaur_array_count_1`, `.test_old_logic_case_120_minotaur_ai_count_1`, `.test_old_logic_case_121_minotaur_bore_count_1`, `.test_old_logic_case_011_standard_bobble_count_4`, `.test_old_logic_case_123_minotaur_liquidator_body_count_1`, `.test_old_logic_case_137_colossus_grip_count_1`, `.test_old_logic_case_125_freighter_interstellar_count_1`, `.test_old_logic_case_140_colossus_mounted_count_4`, `.test_old_logic_case_010_standard_aqua_count_1`, `.test_old_logic_case_127_freighter_fleet_fuel_count_3`, `.test_old_logic_case_143_colossus_cold_count_1`, `.test_old_logic_case_129_freighter_fleet_combat_count_3`, `.test_old_logic_case_130_freighter_fleet_exploration_count_3`, `.test_old_logic_case_131_freighter_fleet_mining_count_3`, `.test_old_logic_case_144_colossus_radiation_count_1`, `.test_old_logic_case_134_colossus_icarus_count_1`, `.test_old_logic_case_145_colossus_toxic_count_1`, `.test_old_logic_case_147_colossus_cyclops_count_1`, `.test_old_logic_case_158_solar_shield_count_5`, `.test_old_logic_case_160_solar_launch_count_6`, `.test_old_logic_case_138_colossus_drift_count_1`, `.test_old_logic_case_139_colossus_mining_count_5`, `.test_corvette_pulse_6_modules_no_override`, `.test_old_logic_case_141_colossus_flamethrower_count_1`, `.test_old_logic_case_142_colossus_thermal_count_1`, `.test_corvette_8_modules_3x3`, `.test_bolt_caster_any_count`, `.test_old_logic_case_146_colossus_radar_count_1`, `.test_old_logic_case_012_standard_conflict_scanner_count_1`, `.test_old_logic_case_148_colossus_excavation_count_1`, `.test_old_logic_case_149_colossus_amplifier_count_1`, `.test_old_logic_case_150_colossus_power_count_1`, `.test_old_logic_case_151_colossus_mineral_count_1`, `.test_old_logic_case_152_solar_cyclotron_count_5`, `.test_old_logic_case_153_solar_infra_count_5`, `.test_old_logic_case_154_solar_phase_count_5`, `.test_old_logic_case_155_solar_photon_count_5`, `.test_old_logic_case_156_solar_positron_count_5`, `.test_old_logic_case_013_standard_economy_scanner_count_1`, `.test_old_logic_case_157_solar_rocket_count_2`, `.test_old_logic_case_159_solar_hyper_count_9`, `.test_old_logic_case_161_solar_pulse_count_9`, `.test_old_logic_case_162_solar_aqua_count_1`, `.test_old_logic_case_163_solar_bobble_count_4`, `.test_pulse_spitter_jetpack_8_plus`, `.test_pulse_6_modules`, `.test_pulse_7_to_8_modules`, `.test_pulse_9_plus_modules`, `.test_generic_fallback_less_than_3`, `.test_generic_fallback_3_modules`, `.test_generic_fallback_4_modules`, `.test_generic_fallback_5_to_6_modules`, `.test_generic_fallback_7_modules`, `.test_generic_fallback_8_modules`, `.test_generic_fallback_10_plus_modules`, `.test_very_large_module_count`, `.test_dimensions_are_positive`, `.test_negative_module_count_treated_as_zero`, `.test_sentinel_photonix_override`, `.test_corvette_pulse_7_modules`, `.test_hyper_12_plus_modules`, `.test_hyper_10_to_11_modules`, `.test_hyper_9_modules`, `.test_hyper_less_than_9_modules`, `.test_old_logic_case_085_sentinel_bobble_count_4`, `.test_old_logic_case_128_freighter_fleet_speed_count_3`?**
  _High betweenness centrality (0.232) - this node is a cross-community bridge._
- **Why does `get_module_data()` connect `get_module_data` to `grid_utils.py`, `optimize_placement`, `data_loader.py`, `app.py`, `TestGetModuleData`, `TestOldDetermineWindowDimensionsBehavior`, `.test_old_logic_case_166_solar_cargo_scanner_count_1`, `.test_old_logic_case_238_staves_cloaking_count_1`, `TestDataLoaderErrorHandling`, `TestDetermineWindowDimensions`, `.test_old_logic_case_176_pilgrim_mounted_count_4`, `.test_old_logic_case_226_staves_analysis_count_1`, `.test_old_logic_case_094_nomad_boost_count_4`, `TestDataIntegrity`, `.test_old_logic_case_095_nomad_slide_count_1`, `.test_old_logic_case_164_solar_conflict_scanner_count_1`, `.test_old_logic_case_165_solar_economy_scanner_count_1`, `.test_old_logic_case_105_nomad_cyclops_count_1`, `determine_window_dimensions`, `.test_old_logic_case_168_solar_teleporter_count_1`, `.test_old_logic_case_014_standard_cargo_scanner_count_1`, `.test_old_logic_case_170_pilgrim_icarus_count_1`, `.test_old_logic_case_172_pilgrim_slide_count_1`, `.test_old_logic_case_173_pilgrim_grip_count_1`, `.test_old_logic_case_174_pilgrim_drift_count_1`, `.test_old_logic_case_175_pilgrim_mining_count_5`, `.test_old_logic_case_169_pilgrim_fusion_count_4`, `.test_old_logic_case_015_standard_trails_count_12`, `.test_old_logic_case_177_pilgrim_flamethrower_count_1`, `.test_old_logic_case_178_pilgrim_thermal_count_1`, `.test_old_logic_case_179_pilgrim_cold_count_1`, `.test_old_logic_case_180_pilgrim_radiation_count_1`, `.test_old_logic_case_181_pilgrim_toxic_count_1`, `.test_old_logic_case_182_pilgrim_cyclops_count_1`, `.test_old_logic_case_183_pilgrim_radar_count_1`, `.test_old_logic_case_184_pilgrim_amplifier_count_1`, `.test_old_logic_case_185_pilgrim_power_count_1`, `.test_old_logic_case_186_nautilon_humboldt_count_5`, `.test_old_logic_case_016_standard_teleporter_count_1`, `.test_old_logic_case_187_nautilon_icarus_count_1`, `.test_old_logic_case_188_nautilon_dredging_count_1`, `.test_old_logic_case_189_nautilon_tethys_count_1`, `.test_old_logic_case_190_nautilon_nautilon_count_4`, `.test_old_logic_case_192_nautilon_sonar_count_1`, `.test_old_logic_case_193_living_grafted_count_4`, `.test_old_logic_case_194_living_spewing_count_4`, `.test_old_logic_case_195_living_scream_count_4`, `.test_old_logic_case_196_living_assembly_count_5`, `.test_old_logic_case_191_nautilon_cyclops_count_1`, `.test_old_logic_case_017_atlantid_mining_count_7`, `.test_old_logic_case_198_living_pulsing_count_4`, `.test_old_logic_case_197_living_singularity_count_5`, `.test_old_logic_case_200_living_bobble_count_4`, `.test_old_logic_case_201_living_scanners_count_2`, `.test_old_logic_case_199_living_saline_count_1`, `.test_old_logic_case_202_living_trails_count_12`, `.test_old_logic_case_204_exosuit_refiner_count_1`, `.test_old_logic_case_205_exosuit_life_count_6`, `.test_old_logic_case_203_exosuit_jetpack_count_8`, `.test_old_logic_case_018_atlantid_analysis_count_1`, `.test_old_logic_case_207_exosuit_anomaly_count_1`, `.test_old_logic_case_208_exosuit_hazard_count_1`, `.test_old_logic_case_209_exosuit_pressure_count_1`, `.test_old_logic_case_038_corvette_phase_count_5`, `.test_old_logic_case_211_exosuit_radiation_count_4`, `.test_old_logic_case_210_exosuit_coolant_count_4`, `.test_old_logic_case_213_exosuit_thermic_count_4`, `.test_old_logic_case_214_exosuit_toxin_count_4`, `.test_old_logic_case_212_exosuit_aeration_count_4`, `.test_old_logic_case_216_exosuit_defense_count_3`, `.test_old_logic_case_215_exosuit_protection_count_4`, `.test_old_logic_case_217_exosuit_rebuilt_count_3`, `.test_old_logic_case_218_exosuit_forbidden_count_3`, `.test_old_logic_case_019_atlantid_fishing_count_1`, `.test_old_logic_case_220_exosuit_hazmat_count_1`, `.test_old_logic_case_221_exosuit_nutrient_count_1`, `.test_old_logic_case_222_exosuit_skiff_count_1`, `.test_old_logic_case_223_exosuit_trade_count_1`, `.test_old_logic_case_224_exosuit_exocraft_count_1`, `.test_old_logic_case_225_staves_mining_count_6`, `.test_old_logic_case_219_exosuit_translators_count_4`, `.test_old_logic_case_020_atlantid_gravatino_count_1`, `.test_old_logic_case_227_staves_fishing_count_1`, `.test_old_logic_case_228_staves_gravatino_count_1`, `.test_old_logic_case_229_staves_scanner_count_7`, `.test_old_logic_case_230_staves_survey_count_1`, `.test_old_logic_case_231_staves_blaze_javelin_count_6`, `.test_old_logic_case_232_staves_bolt_caster_count_9`, `.test_old_logic_case_233_staves_geology_count_4`, `.test_old_logic_case_234_staves_neutron_count_5`, `.test_old_logic_case_235_staves_plasma_launcher_count_4`, `.test_old_logic_case_236_staves_pulse_spitter_count_7`, `.test_old_logic_case_021_atlantid_scanner_count_7`, `.test_old_logic_case_237_staves_scatter_count_5`, `.test_old_logic_case_171_pilgrim_boost_count_4`, `.test_old_logic_case_239_staves_combat_count_1`, `.test_old_logic_case_240_staves_voltaic_amplifier_count_1`, `.test_old_logic_case_241_staves_paralysis_count_1`, `.test_old_logic_case_242_staves_personal_count_1`, `.test_old_logic_case_243_staves_terrian_count_1`, `.test_old_logic_case_244_sentinel_mt_mining_count_7`, `.test_old_logic_case_245_sentinel_mt_analysis_count_1`, `.test_old_logic_case_246_sentinel_mt_fishing_count_1`, `.test_old_logic_case_022_atlantid_survey_count_1`, `.test_old_logic_case_247_sentinel_mt_gravatino_count_1`, `.test_old_logic_case_248_sentinel_mt_scanner_count_7`, `.test_old_logic_case_249_sentinel_mt_survey_count_1`, `.test_old_logic_case_250_sentinel_mt_blaze_javelin_count_6`, `.test_old_logic_case_252_sentinel_mt_geology_count_4`, `.test_old_logic_case_253_sentinel_mt_neutron_count_5`, `.test_old_logic_case_254_sentinel_mt_plasma_launcher_count_4`, `.test_old_logic_case_255_sentinel_mt_pulse_spitter_count_7`, `.test_old_logic_case_023_atlantid_blaze_javelin_count_6`, `.test_old_logic_case_256_sentinel_mt_scatter_count_5`, `.test_old_logic_case_258_sentinel_mt_combat_count_1`, `.test_old_logic_case_259_sentinel_mt_voltaic_amplifier_count_1`, `.test_old_logic_case_260_sentinel_mt_paralysis_count_1`, `.test_old_logic_case_257_sentinel_mt_cloaking_count_1`, `.test_old_logic_case_262_sentinel_mt_terrian_count_1`, `.test_old_logic_case_261_sentinel_mt_personal_count_1`, `.test_old_logic_case_263_roamer_fusion_count_4`, `.test_old_logic_case_265_roamer_boost_count_4`, `.test_old_logic_case_266_roamer_slide_count_1`, `.test_old_logic_case_024_atlantid_bolt_caster_count_9`, `.test_old_logic_case_264_roamer_icarus_count_1`, `.test_old_logic_case_268_roamer_drift_count_1`, `.test_old_logic_case_267_roamer_grip_count_1`, `.test_old_logic_case_270_roamer_mounted_count_4`, `.test_old_logic_case_059_standard_mt_scanner_count_7`, `.test_old_logic_case_269_roamer_mining_count_5`, `.test_old_logic_case_272_roamer_thermal_count_1`, `.test_old_logic_case_072_standard_mt_personal_count_1`, `.test_old_logic_case_275_roamer_toxic_count_1`, `.test_old_logic_case_276_roamer_cyclops_count_1`, `.test_old_logic_case_025_atlantid_geology_count_4`, `.test_old_logic_case_274_roamer_radiation_count_1`, `.test_old_logic_case_277_roamer_radar_count_1`, `.test_old_logic_case_278_roamer_amplifier_count_1`, `.test_old_logic_case_279_roamer_power_count_1`, `.test_old_logic_case_000_standard_cyclotron_count_5`, `.test_old_logic_case_027_atlantid_plasma_launcher_count_4`, `.test_old_logic_case_028_atlantid_pulse_spitter_count_7`, `.test_old_logic_case_251_sentinel_mt_bolt_caster_count_9`, `.test_old_logic_case_030_atlantid_cloaking_count_1`, `.test_old_logic_case_026_atlantid_neutron_count_5`, `.test_old_logic_case_029_atlantid_scatter_count_5`, `.test_old_logic_case_031_atlantid_combat_count_1`, `.test_old_logic_case_034_atlantid_personal_count_1`, `.test_old_logic_case_035_atlantid_terrian_count_1`, `.test_old_logic_case_036_corvette_cyclotron_count_5`, `.test_old_logic_case_074_sentinel_cyclotron_count_5`, `.test_old_logic_case_032_atlantid_voltaic_amplifier_count_1`, `.test_old_logic_case_033_atlantid_paralysis_count_1`, `.test_old_logic_case_039_corvette_photon_count_5`, `.test_old_logic_case_037_corvette_infra_count_5`, `.test_old_logic_case_041_corvette_rocket_count_2`, `.test_old_logic_case_043_corvette_hyper_count_9`, `.test_old_logic_case_042_corvette_shield_count_5`, `.test_old_logic_case_084_sentinel_aqua_count_1`, `.test_old_logic_case_046_corvette_pulse_count_8`, `.test_old_logic_case_002_standard_phase_count_5`, `.test_old_logic_case_047_corvette_habitation_count_3`, `.test_old_logic_case_044_corvette_cockpit_count_1`, `.test_old_logic_case_049_corvette_bobble_count_4`, `.test_old_logic_case_050_corvette_conflict_scanner_count_1`, `.test_old_logic_case_048_corvette_aqua_count_1`, `.test_old_logic_case_052_corvette_cargo_scanner_count_1`, `.test_old_logic_case_051_corvette_economy_scanner_count_1`, `.test_old_logic_case_053_corvette_trails_count_12`, `.test_old_logic_case_055_standard_mt_mining_count_6`, `.test_old_logic_case_056_standard_mt_analysis_count_1`, `.test_old_logic_case_003_standard_photon_count_5`, `.test_old_logic_case_057_standard_mt_fishing_count_1`, `.test_old_logic_case_054_corvette_teleporter_count_1`, `.test_old_logic_case_058_standard_mt_gravatino_count_1`, `.test_old_logic_case_060_standard_mt_survey_count_1`, `.test_old_logic_case_061_standard_mt_blaze_javelin_count_6`, `.test_old_logic_case_062_standard_mt_bolt_caster_count_9`, `.test_old_logic_case_064_standard_mt_neutron_count_5`, `.test_old_logic_case_065_standard_mt_plasma_launcher_count_4`, `.test_old_logic_case_066_standard_mt_pulse_spitter_count_7`, `.test_old_logic_case_004_standard_positron_count_5`, `.test_old_logic_case_063_standard_mt_geology_count_4`, `.test_old_logic_case_067_standard_mt_scatter_count_5`, `.test_old_logic_case_068_standard_mt_cloaking_count_1`, `.test_old_logic_case_069_standard_mt_combat_count_1`, `.test_old_logic_case_071_standard_mt_paralysis_count_1`, `.test_old_logic_case_040_corvette_positron_count_5`, `.test_old_logic_case_089_sentinel_cargo_scanner_count_1`, `.test_old_logic_case_073_standard_mt_terrian_count_1`, `.test_old_logic_case_096_nomad_grip_count_1`, `.test_old_logic_case_076_sentinel_phase_count_5`, `.test_old_logic_case_111_minotaur_icarus_count_1`, `.test_old_logic_case_077_sentinel_positron_count_5`, `.test_old_logic_case_079_sentinel_photon_count_5`, `.test_old_logic_case_080_sentinel_shield_count_5`, `.test_old_logic_case_081_sentinel_launch_count_6`, `.test_old_logic_case_078_sentinel_rocket_count_2`, `.test_old_logic_case_083_sentinel_pulse_count_8`, `.test_old_logic_case_082_sentinel_hyper_count_9`, `.test_old_logic_case_086_sentinel_pilot_count_1`, `.test_old_logic_case_006_standard_shield_count_5`, `.test_old_logic_case_087_sentinel_conflict_scanner_count_1`, `.test_old_logic_case_088_sentinel_economy_scanner_count_1`, `.test_old_logic_case_091_sentinel_teleporter_count_1`, `.test_old_logic_case_090_sentinel_trails_count_12`, `.test_old_logic_case_093_nomad_icarus_count_1`, `.test_old_logic_case_092_nomad_fusion_count_4`, `.test_old_logic_case_007_standard_hyper_count_9`, `.test_old_logic_case_097_nomad_drift_count_1`, `.test_old_logic_case_099_nomad_mounted_count_4`, `.test_old_logic_case_104_nomad_toxic_count_1`, `.test_old_logic_case_008_standard_launch_count_6`, `.test_old_logic_case_098_nomad_mining_count_5`, `.test_old_logic_case_109_minotaur_daedalus_count_7`, `.test_old_logic_case_100_nomad_flamethrower_count_1`, `.test_old_logic_case_101_nomad_thermal_count_1`, `.test_old_logic_case_102_nomad_cold_count_1`, `.test_old_logic_case_124_freighter_hyper_count_11`, `.test_old_logic_case_110_minotaur_ariadnes_count_1`, `.test_old_logic_case_116_minotaur_liquidator_left_count_1`, `.test_old_logic_case_106_nomad_radar_count_1`, `.test_old_logic_case_009_standard_pulse_count_8`, `.test_old_logic_case_107_nomad_amplifier_count_1`, `.test_old_logic_case_108_nomad_power_count_1`, `.test_old_logic_case_122_minotaur_hardframe_body_count_1`, `.test_old_logic_case_132_freighter_fleet_trade_count_3`, `.test_old_logic_case_133_colossus_fusion_count_4`, `.test_old_logic_case_112_minotaur_minotaur_laser_count_6`, `.test_old_logic_case_113_minotaur_minotaur_count_4`, `.test_old_logic_case_114_minotaur_hardframe_right_count_1`, `.test_old_logic_case_126_freighter_matterbeam_count_1`, `.test_old_logic_case_135_colossus_boost_count_4`, `.test_old_logic_case_136_colossus_slide_count_1`, `.test_old_logic_case_117_minotaur_environment_count_1`, `.test_old_logic_case_118_minotaur_cyclops_count_1`, `.test_old_logic_case_119_minotaur_array_count_1`, `.test_old_logic_case_120_minotaur_ai_count_1`, `.test_old_logic_case_121_minotaur_bore_count_1`, `.test_old_logic_case_011_standard_bobble_count_4`, `.test_old_logic_case_123_minotaur_liquidator_body_count_1`, `.test_old_logic_case_137_colossus_grip_count_1`, `.test_old_logic_case_125_freighter_interstellar_count_1`, `.test_old_logic_case_140_colossus_mounted_count_4`, `.test_old_logic_case_010_standard_aqua_count_1`, `.test_old_logic_case_127_freighter_fleet_fuel_count_3`, `.test_old_logic_case_143_colossus_cold_count_1`, `.test_old_logic_case_129_freighter_fleet_combat_count_3`, `.test_old_logic_case_130_freighter_fleet_exploration_count_3`, `.test_old_logic_case_131_freighter_fleet_mining_count_3`, `.test_old_logic_case_144_colossus_radiation_count_1`, `.test_old_logic_case_134_colossus_icarus_count_1`, `.test_old_logic_case_145_colossus_toxic_count_1`, `.test_old_logic_case_147_colossus_cyclops_count_1`, `.test_old_logic_case_158_solar_shield_count_5`, `.test_old_logic_case_160_solar_launch_count_6`, `.test_old_logic_case_138_colossus_drift_count_1`, `.test_old_logic_case_139_colossus_mining_count_5`, `.test_old_logic_case_141_colossus_flamethrower_count_1`, `.test_old_logic_case_142_colossus_thermal_count_1`, `.test_old_logic_case_146_colossus_radar_count_1`, `.test_old_logic_case_012_standard_conflict_scanner_count_1`, `.test_old_logic_case_148_colossus_excavation_count_1`, `.test_old_logic_case_149_colossus_amplifier_count_1`, `.test_old_logic_case_150_colossus_power_count_1`, `.test_old_logic_case_151_colossus_mineral_count_1`, `.test_old_logic_case_152_solar_cyclotron_count_5`, `.test_old_logic_case_153_solar_infra_count_5`, `.test_old_logic_case_154_solar_phase_count_5`, `.test_old_logic_case_155_solar_photon_count_5`, `.test_old_logic_case_156_solar_positron_count_5`, `.test_old_logic_case_013_standard_economy_scanner_count_1`, `.test_old_logic_case_157_solar_rocket_count_2`, `.test_old_logic_case_159_solar_hyper_count_9`, `.test_old_logic_case_161_solar_pulse_count_9`, `.test_old_logic_case_162_solar_aqua_count_1`, `.test_old_logic_case_163_solar_bobble_count_4`, `.test_corvette_pulse_7_modules`, `.test_old_logic_case_085_sentinel_bobble_count_4`, `.test_old_logic_case_128_freighter_fleet_speed_count_3`?**
...
- **Should `grid_utils.py` be split into smaller, more focused modules?**
