...
class TestPatternRotation(unittest.TestCase):
    ...
    def test_rotate_3x3_pattern_four_times_returns_original(self):
        ...
        pattern = {(0, 0): "A", (1, 0): "B", (2, 0): "C", (0, 1): "D", (1, 1): "E", (2, 1): "F"}
...
class TestPatternVariationGeneration(unittest.TestCase):
    ...
    def test_all_variations_preserve_module_count(self):
        ...
        for var in variations:
            self.assertEqual(len(var), len(pattern), f"Variation {var} has different count than original")
    ...
    def test_no_duplicate_variations(self):
        ...
        self.assertEqual(
            len(variations_as_tuples), len(unique_variations), "There are duplicate variations in the generated list"
        )
...
class TestPatternApplicationToGrid(unittest.TestCase):
    ...
    def test_apply_pattern_to_empty_grid(self):
        ...
        new_grid, score = apply_pattern_to_grid(self.grid, pattern, self.modules_data, "pulse", 0, 0, "corvette")
    ...
    def test_apply_pattern_with_negative_offset(self):
        ...
        pattern = {(0, 0): "pulse_a"}
        new_grid, score = apply_pattern_to_grid(self.grid, pattern, self.modules_data, "pulse", -1, 0, "corvette")
    ...
    def test_apply_pattern_preserves_other_tech_modules(self):
        ...
        self.assertIsNotNone(new_grid)
        if new_grid is not None:
            self.assertEqual(new_grid.get_cell(2, 2)["tech"], "engineering", "Other tech modules should be preserved")
